...
export function jsonLdCategories(categories: Category[], title: string, description: string, path: string, lang: string): string {
...
export function jsonLdPost({ title, summary, previewimage, created, modified, keywords, author }: PostProps): string {
