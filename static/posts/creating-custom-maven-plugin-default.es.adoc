...
Ya expliqué en el articulo link:/langs/es/posts/creating-custom-maven-plugin[cómo crear un plugin para Maven] which https://maven.apache.org/ref/3.5.3/maven-core/lifecycles.html#site_Lifecycle[que sobrescribe el ciclo de vida "site"].
