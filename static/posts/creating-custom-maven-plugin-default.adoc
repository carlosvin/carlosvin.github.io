...
I explained in previous article link:/langs/en/posts/creating-custom-maven-plugin[Example how to create custom Maven Plugin] which https://maven.apache.org/ref/3.5.3/maven-core/lifecycles.html#site_Lifecycle[overrides site lifecycle].
