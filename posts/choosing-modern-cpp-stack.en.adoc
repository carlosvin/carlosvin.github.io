...
{gradle}::
  CPP feature is still incubating. Not very fast. You can check a similar example project at link:/langs/{lang}/posts/gradle-cpp[Build C++ project with Gradle,window=_blank].
{make_link}::
