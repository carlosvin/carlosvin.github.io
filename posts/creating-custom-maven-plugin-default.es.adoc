...
Ya expliqué en el articulo link:/langs/{lang}/posts/creating-custom-maven-plugin[cómo crear un plugin para Maven,window=_blank] which https://maven.apache.org/ref/3.5.3/maven-core/lifecycles.html#site_Lifecycle[que sobrescribe el ciclo de vida "site"].
