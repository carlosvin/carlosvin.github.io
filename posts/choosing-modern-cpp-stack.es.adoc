...
{gradle}::
  La construcción de proyectos C++ está todavía en desarrollo, los modelos y APIs están cambiando. No es muy rápido. Puedes ver un ejemplo en este artículo link:/blog/gradle-cpp/{lang}[Construir un proyecto Cpp con Gradle].
{make_link}::
...
=== Comparaciones de sistemas de construcción
...
TIP: Puedes encontrar las instrucciones para construir y ejecutar el proyecto de ejemplo en: https://github.com/carlosvin/uuid-cpp
