...
:description: En este artículo explico las razones por las que he elegido este conjunto de tecnologías para crear un proyecto en C++. También contiene un ejemplo fácil de ejecutar y de reutilizar como template.
:lang: es
:toc:
